          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{route('application.index')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Boxicons">Job Applications</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="{{route('job.index')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Boxicons">Jobs</div>
              </a>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{url('images/')}}/{{auth::user()->picture}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
